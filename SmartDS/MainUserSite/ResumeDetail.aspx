...
<asp:Content ID="Content2" ContentPlaceHolderID="badyContent" runat="server">
    <%if(_user!=null){ %>
     ...
     <div class="textdiv">用户名：<span id="LoginName" ><%=_user.LoginName %></span></div>
     <div class="textdiv">姓名：<span id="UserName" ><%=_user.UserName %></span></div>
      <div class="textdiv">性别：<span id="Sex" ><%=_user.Sex?"男":"女" %></span></div>
      <div class="textdiv">国籍：<span id="Nation"><%=_user.Nationality %></span></div>
      <div class="textdiv">手机号：<span id="Mobile" ><%=_user.Mobile %></span></div>
    <div class="textdiv">Email：<span id="Email" ><%=_user.Email %></span></div>
